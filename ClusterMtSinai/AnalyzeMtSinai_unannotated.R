...
list.names <- c("N-2","N-1","N-4","N-3","N-5")
...
GOclust1 <- enrichGO(entrezClust1, 'org.Hs.eg.db', ont="BP", pvalueCutoff = 0.05 , pAdjustMethod = "fdr", readable= TRUE) # N2
GOclust2 <- enrichGO(entrezClust2, 'org.Hs.eg.db', ont="BP", pvalueCutoff = 0.05 , pAdjustMethod = "fdr", readable= TRUE) # N1
GOclust3 <- enrichGO(entrezClust3, 'org.Hs.eg.db', ont="BP", pvalueCutoff = 0.05 , pAdjustMethod = "fdr", readable= TRUE) # N4
GOclust4 <- enrichGO(entrezClust4, 'org.Hs.eg.db', ont="BP", pvalueCutoff = 0.05 , pAdjustMethod = "fdr", readable= TRUE) # N3
GOclust5 <- enrichGO(entrezClust5, 'org.Hs.eg.db', ont="BP", pvalueCutoff = 0.05 , pAdjustMethod = "fdr", readable= TRUE) # N5

#plot GO results 
png("./GO/GO_neuron_N2.png")
barplot(GOclust1)
dev.off()
...
# treeplot(BPtree3, nCluster = 3)
# treeplot(BPtree4, nCluster = 3)
# treeplot(BPtree5, nCluster = 3)
...
list.names <- c("A-4","A-5","A-3","A-1","A-2")
...
list.names <- c("M-1","M-2","M-5","M-3","M-4")
